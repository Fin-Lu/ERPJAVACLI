...
public class Etsy_Kalkulator_CLI {
    ...
    public void start() {
        try {
            ...
            final double druckerLebensdauer = 2000.0;
            final double umsatzsteuer = 1.19;
            final double versandHermes = 4.50;
            final double verpackungsKosten = 1.50;
            final double etsyAnteilInProzent = 1.13;
            final double etsyKosenInEuro = 0.50;
            ...
            double kostenproVerkaufStk = (kostenProStueck + etsyKosenInEuro + versandHermes + verpackungsKosten) * etsyAnteilInProzent;
            double gesamtKosten = kostenproVerkaufStk * stueckzahl;
            ...
            System.out.println("\nFEHLER: Bitte gültige Eingabe machen.");
        }
    }
